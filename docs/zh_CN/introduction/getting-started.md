...
```shell
$ go install github.com/MysticalDevil/clash@latest
go: downloading github.com/MysticalDevil/clash v1.15.1
```
...
```shell
$ git clone --depth 1 https://github.com/MysticalDevil/clash
Cloning into 'clash'...
